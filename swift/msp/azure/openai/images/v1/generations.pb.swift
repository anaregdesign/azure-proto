...
public struct Msp_Azure_Openai_Images_V1_ImageGenerationsRequest {
...
public struct Msp_Azure_Openai_Images_V1_ImageGenerationsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var data: Msp_Azure_Openai_Images_V1_ImageResult {
    get {return _data ?? Msp_Azure_Openai_Images_V1_ImageResult()}
    set {_data = newValue}
  }
  ...
  fileprivate var _data: Msp_Azure_Openai_Images_V1_ImageResult? = nil
}

public struct Msp_Azure_Openai_Images_V1_ImageResult {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var contentFilterResult: Msp_Azure_Openai_Images_V1_DalleContentFilterResult {
    get {return _storage._contentFilterResult ?? Msp_Azure_Openai_Images_V1_DalleContentFilterResult()}
  ...
  public var promptFilterResult: Msp_Azure_Openai_Images_V1_DalleFilterResult {
    get {return _storage._promptFilterResult ?? Msp_Azure_Openai_Images_V1_DalleFilterResult()}
...
public struct Msp_Azure_Openai_Images_V1_DalleContentFilterResult {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Msp_Azure_Openai_Images_V1_DalleFilterResult {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Msp_Azure_Openai_Images_V1_ImageGenerationsRequest: @unchecked Sendable {}
extension Msp_Azure_Openai_Images_V1_ImageGenerationsResponse: @unchecked Sendable {}
extension Msp_Azure_Openai_Images_V1_ImageResult: @unchecked Sendable {}
extension Msp_Azure_Openai_Images_V1_DalleContentFilterResult: @unchecked Sendable {}
extension Msp_Azure_Openai_Images_V1_DalleFilterResult: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "msp.azure.openai.images.v1"

extension Msp_Azure_Openai_Images_V1_ImageGenerationsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Msp_Azure_Openai_Images_V1_ImageGenerationsRequest, rhs: Msp_Azure_Openai_Images_V1_ImageGenerationsRequest) -> Bool {
...
extension Msp_Azure_Openai_Images_V1_ImageGenerationsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Msp_Azure_Openai_Images_V1_ImageGenerationsResponse, rhs: Msp_Azure_Openai_Images_V1_ImageGenerationsResponse) -> Bool {
...
extension Msp_Azure_Openai_Images_V1_ImageResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _contentFilterResult: Msp_Azure_Openai_Images_V1_DalleContentFilterResult? = nil
    var _revisedPrompt: String = String()
    var _promptFilterResult: Msp_Azure_Openai_Images_V1_DalleFilterResult? = nil
  ...
  public static func ==(lhs: Msp_Azure_Openai_Images_V1_ImageResult, rhs: Msp_Azure_Openai_Images_V1_ImageResult) -> Bool {
...
extension Msp_Azure_Openai_Images_V1_DalleContentFilterResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Msp_Azure_Openai_Images_V1_DalleContentFilterResult, rhs: Msp_Azure_Openai_Images_V1_DalleContentFilterResult) -> Bool {
...
extension Msp_Azure_Openai_Images_V1_DalleFilterResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Msp_Azure_Openai_Images_V1_DalleFilterResult, rhs: Msp_Azure_Openai_Images_V1_DalleFilterResult) -> Bool {
    if lhs._sexual != rhs._sexual {return false}
    if lhs._violence != rhs._violence {return false}
    if lhs._hate != rhs._hate {return false}
    if lhs._selfHarm != rhs._selfHarm {return false}
