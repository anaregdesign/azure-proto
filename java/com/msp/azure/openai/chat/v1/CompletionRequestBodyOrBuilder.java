...
public interface CompletionRequestBodyOrBuilder extends
    // @@protoc_insertion_point(interface_extends:msp.azure.openai.chat.v1.CompletionRequestBody)
   ...
   */
  java.util.List<com.msp.azure.openai.chat.v1.CompletionRequestBody.Message> 
      getMessagesList();
  /**
   * <code>repeated .msp.azure.openai.chat.v1.CompletionRequestBody.Message messages = 10 [json_name = "messages"];</code>
   */
  com.msp.azure.openai.chat.v1.CompletionRequestBody.Message getMessages(int index);
  /**
   * <code>repeated .msp.azure.openai.chat.v1.CompletionRequestBody.Message messages = 10 [json_name = "messages"];</code>
   */
   ...
   * <code>repeated .msp.azure.openai.chat.v1.CompletionRequestBody.Message messages = 10 [json_name = "messages"];</code>
   */
  java.util.List<? extends com.msp.azure.openai.chat.v1.CompletionRequestBody.MessageOrBuilder> 
      getMessagesOrBuilderList();
  /**
   * <code>repeated .msp.azure.openai.chat.v1.CompletionRequestBody.Message messages = 10 [json_name = "messages"];</code>
   */
  com.msp.azure.openai.chat.v1.CompletionRequestBody.MessageOrBuilder getMessagesOrBuilder(
      int index);
