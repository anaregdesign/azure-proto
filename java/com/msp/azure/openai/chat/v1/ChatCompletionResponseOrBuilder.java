...
public interface ChatCompletionResponseOrBuilder extends
   ...
   * @return The usage.
   */
  com.msp.azure.openai.chat.v1.Usage getUsage();
  /**
   * <code>.msp.azure.openai.chat.v1.Usage usage = 5 [json_name = "usage"];</code>
   */
  com.msp.azure.openai.chat.v1.UsageOrBuilder getUsageOrBuilder();
   ...
   */
  java.util.List<com.msp.azure.openai.chat.v1.Choice> 
      getChoicesList();
  /**
   * <code>repeated .msp.azure.openai.chat.v1.Choice choices = 8 [json_name = "choices"];</code>
   */
  com.msp.azure.openai.chat.v1.Choice getChoices(int index);
  /**
   * <code>repeated .msp.azure.openai.chat.v1.Choice choices = 8 [json_name = "choices"];</code>
   */
  int getChoicesCount();
   ...
   * <code>repeated .msp.azure.openai.chat.v1.Choice choices = 8 [json_name = "choices"];</code>
   */
  java.util.List<? extends com.msp.azure.openai.chat.v1.ChoiceOrBuilder> 
      getChoicesOrBuilderList();
  /**
   * <code>repeated .msp.azure.openai.chat.v1.Choice choices = 8 [json_name = "choices"];</code>
   */
  com.msp.azure.openai.chat.v1.ChoiceOrBuilder getChoicesOrBuilder(
      int index);
}
