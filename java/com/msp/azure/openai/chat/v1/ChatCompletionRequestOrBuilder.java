...
public interface ChatCompletionRequestOrBuilder extends
   ...
   */
  java.util.List<com.msp.azure.openai.chat.v1.ChatCompletionRequestMessage> 
      getMessagesList();
  /**
   * <code>repeated .msp.azure.openai.chat.v1.ChatCompletionRequestMessage messages = 10 [json_name = "messages"];</code>
   */
  com.msp.azure.openai.chat.v1.ChatCompletionRequestMessage getMessages(int index);
  /**
   * <code>repeated .msp.azure.openai.chat.v1.ChatCompletionRequestMessage messages = 10 [json_name = "messages"];</code>
   */
   ...
   * <code>repeated .msp.azure.openai.chat.v1.ChatCompletionRequestMessage messages = 10 [json_name = "messages"];</code>
   */
  java.util.List<? extends com.msp.azure.openai.chat.v1.ChatCompletionRequestMessageOrBuilder> 
      getMessagesOrBuilderList();
  /**
   * <code>repeated .msp.azure.openai.chat.v1.ChatCompletionRequestMessage messages = 10 [json_name = "messages"];</code>
   */
  com.msp.azure.openai.chat.v1.ChatCompletionRequestMessageOrBuilder getMessagesOrBuilder(
      int index);
