...
class EmbeddingRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EmbeddingRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'msp.azure.openai.v1'), createEmptyInstance: create)
...
class EmbeddingResponse_Usage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EmbeddingResponse.Usage', package: const $pb.PackageName(_omitMessageNames ? '' : 'msp.azure.openai.v1'), createEmptyInstance: create)
