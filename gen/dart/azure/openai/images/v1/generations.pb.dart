...
class ImageGenerationsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ImageGenerationsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'azure.openai.images.v1'), createEmptyInstance: create)
...
class ImageGenerationsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ImageGenerationsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'azure.openai.images.v1'), createEmptyInstance: create)
...
class ImageResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ImageResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'azure.openai.images.v1'), createEmptyInstance: create)
...
class DalleContentFilterResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DalleContentFilterResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'azure.openai.images.v1'), createEmptyInstance: create)
...
class DalleFilterResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DalleFilterResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'azure.openai.images.v1'), createEmptyInstance: create)
    ..aOM<$0.ContentFilterSeverityResult>(1, _omitFieldNames ? '' : 'sexual', subBuilder: $0.ContentFilterSeverityResult.create)
    ..aOM<$0.ContentFilterSeverityResult>(2, _omitFieldNames ? '' : 'violence', subBuilder: $0.ContentFilterSeverityResult.create)
    ..aOM<$0.ContentFilterSeverityResult>(3, _omitFieldNames ? '' : 'hate', subBuilder: $0.ContentFilterSeverityResult.create)
    ..aOM<$0.ContentFilterSeverityResult>(4, _omitFieldNames ? '' : 'selfHarm', subBuilder: $0.ContentFilterSeverityResult.create)
