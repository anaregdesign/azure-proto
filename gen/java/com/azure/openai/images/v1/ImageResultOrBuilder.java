...
public interface ImageResultOrBuilder extends
    // @@protoc_insertion_point(interface_extends:azure.openai.images.v1.ImageResult)
   ...
   */
  com.azure.openai.images.v1.DalleContentFilterResult getContentFilterResult();
  /**
   * <code>.azure.openai.images.v1.DalleContentFilterResult content_filter_result = 3 [json_name = "content_filter_results"];</code>
   */
  com.azure.openai.images.v1.DalleContentFilterResultOrBuilder getContentFilterResultOrBuilder();
   ...
   */
  com.azure.openai.images.v1.DalleFilterResult getPromptFilterResult();
  /**
   * <code>.azure.openai.images.v1.DalleFilterResult prompt_filter_result = 5 [json_name = "prompt_filter_results"];</code>
   */
  com.azure.openai.images.v1.DalleFilterResultOrBuilder getPromptFilterResultOrBuilder();
}
