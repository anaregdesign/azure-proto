...
public struct Azure_Openai_V1_PromptFilterResult {
  ...
  public var contentFilterResult: Azure_Openai_V1_ContentFilterPromptResult {
    get {return _contentFilterResult ?? Azure_Openai_V1_ContentFilterPromptResult()}
  ...
  fileprivate var _contentFilterResult: Azure_Openai_V1_ContentFilterPromptResult? = nil
}

public struct Azure_Openai_V1_ErrorBase {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Azure_Openai_V1_ContentFilterPromptResult {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var error: Azure_Openai_V1_ErrorBase {
    get {return _error ?? Azure_Openai_V1_ErrorBase()}
    set {_error = newValue}
  }
  ...
  fileprivate var _error: Azure_Openai_V1_ErrorBase? = nil
}

public struct Azure_Openai_V1_ContentFilterChoiceResult {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var profanity: Azure_Openai_V1_ContentFilterDetectedResult {
    get {return _storage._profanity ?? Azure_Openai_V1_ContentFilterDetectedResult()}
  ...
  public var protectedMaterialCode: Azure_Openai_V1_ContentFilterDetectedWithCitationResult {
    get {return _storage._protectedMaterialCode ?? Azure_Openai_V1_ContentFilterDetectedWithCitationResult()}
  ...
  public var error: Azure_Openai_V1_ErrorBase {
    get {return _storage._error ?? Azure_Openai_V1_ErrorBase()}
...
public struct Azure_Openai_V1_ContentFilterDetectedWithCitationResult {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var citation: Azure_Openai_V1_ContentFilterDetectedWithCitationResult.Citation {
    get {return _citation ?? Azure_Openai_V1_ContentFilterDetectedWithCitationResult.Citation()}
  ...
  fileprivate var _citation: Azure_Openai_V1_ContentFilterDetectedWithCitationResult.Citation? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Azure_Openai_V1_PromptFilterResult: @unchecked Sendable {}
extension Azure_Openai_V1_ErrorBase: @unchecked Sendable {}
extension Azure_Openai_V1_ContentFilterPromptResult: @unchecked Sendable {}
extension Azure_Openai_V1_ContentFilterChoiceResult: @unchecked Sendable {}
...
extension Azure_Openai_V1_ContentFilterDetectedWithCitationResult: @unchecked Sendable {}
extension Azure_Openai_V1_ContentFilterDetectedWithCitationResult.Citation: @unchecked Sendable {}
...
extension Azure_Openai_V1_PromptFilterResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Azure_Openai_V1_PromptFilterResult, rhs: Azure_Openai_V1_PromptFilterResult) -> Bool {
...
extension Azure_Openai_V1_ErrorBase: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Azure_Openai_V1_ErrorBase, rhs: Azure_Openai_V1_ErrorBase) -> Bool {
...
extension Azure_Openai_V1_ContentFilterPromptResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Azure_Openai_V1_ContentFilterPromptResult, rhs: Azure_Openai_V1_ContentFilterPromptResult) -> Bool {
...
extension Azure_Openai_V1_ContentFilterChoiceResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _profanity: Azure_Openai_V1_ContentFilterDetectedResult? = nil
    var _protectedMaterialText: Azure_Openai_V1_ContentFilterDetectedResult? = nil
    var _protectedMaterialCode: Azure_Openai_V1_ContentFilterDetectedWithCitationResult? = nil
    var _error: Azure_Openai_V1_ErrorBase? = nil
  ...
  public static func ==(lhs: Azure_Openai_V1_ContentFilterChoiceResult, rhs: Azure_Openai_V1_ContentFilterChoiceResult) -> Bool {
...
extension Azure_Openai_V1_ContentFilterDetectedWithCitationResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Azure_Openai_V1_ContentFilterDetectedWithCitationResult, rhs: Azure_Openai_V1_ContentFilterDetectedWithCitationResult) -> Bool {
    if lhs.filtered != rhs.filtered {return false}
    if lhs.detected != rhs.detected {return false}
...
extension Azure_Openai_V1_ContentFilterDetectedWithCitationResult.Citation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Azure_Openai_V1_ContentFilterDetectedWithCitationResult.protoMessageName + ".Citation"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "url"),
  ...
  public static func ==(lhs: Azure_Openai_V1_ContentFilterDetectedWithCitationResult.Citation, rhs: Azure_Openai_V1_ContentFilterDetectedWithCitationResult.Citation) -> Bool {
